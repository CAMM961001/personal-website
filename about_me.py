...
class AboutMe:
    ...
    def main_content(self):
        ...
        <p style="font-size: 20px">
            <br>
            I am a data scientist with expierence in automotive industry, manufacturing processes, and
            financial services. I am currently studying a full time Masters Program in Data Science at
            {itam_url}
            </br>
            <br>Line 2</br>
        </p>'''
